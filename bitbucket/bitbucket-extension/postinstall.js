...
info(
  ...
  `$ amplify central config set extensions.bitbucket-extension ${process.cwd()}${path.sep}node_modules${path.sep}@axway${path.sep}amplify-central-bitbucket-extension`
);
