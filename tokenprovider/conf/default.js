...
module.exports = {
  ...
  // API key
  apikey: "Oz45KL9MNixSlgGz7/lkVmUVkHeFPk0B",
  ...
  session: {
    ...
    encryptionKey: "UvbGI4IvhEQRTPfKEK5iHAD64JeedJN2GvK5VfqqmEQ=",
    signatureAlgorithm: "sha512-drop256",
    signatureKey:
      "3NUa6QcMXpI6FGrgzkpWQFG/KBzgUKMA4nnp9wjafUccjpa0qU4E8o/7Nlwt7RZ36Frh/vVzsHme4OE31OqGDg==",
    // should be a large unguessable string
    secret: "xUKK+oqw0ZuhTHivVT3pRWM6fSyLcKF5",
  ...
  cookieSecret: "Cmy8ZaLLJYy3EAoHys2T6obMqELlDNle",
  ...
  authorization: {
    credentials: {
      central: {
        ...
        flow: "accessCode",
        authentication_url:
          "https://login.axway.com/auth/realms/Broker/protocol/openid-connect/auth",
        token_url:
          "https://login.axway.com/auth/realms/Broker/protocol/openid-connect/token",
        client_id: "apicentral",
        client_secret: "",
        scope: "openid",
        access_token: process.env.ACCESS_TOKEN || null,
        refresh_token: process.env.REFRESH_TOKEN || null,
        redirect_uri: process.env.CALLBACK_URI || "http://localhost:8080/auth/callback",
      },
    },
  },
};
