...
```bash
$ amplify pm install @axway/amplify-central-apigee-extension
```

To configure this extension with the AMPLIFY Central CLI:

```bash
$ amplify central config set extensions.apigee-extension '~/.axway/packages/@axway/amplify-central-apigee-extension'
```
